package br.com.dgusto.facade.employee;
...
@Service
public class RequestEmployeeFacade {

    private final RequestService requestService;
    private final RequestMapper requestMapper;

    public RequestEmployeeFacade(
    ...
    @Transactional
    public RequestDTO update(RequestToEmployeeUpdateDTO dto) {
        Request entity = requestMapper.toEmployeeUpdateEntity(dto);
